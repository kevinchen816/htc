...
<div class="row">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Terms and Conditions of your Account</li>
    </ol>
...
<div class="container">
    <div id="legal_doc" class="legal_doc">
        ...
        <div class="para40">
            <p>
                <strong>Billing Cycle: </strong> Billing Cycles, assigned as the day of the month a member makes his/her initial purchase, are used to determine when accounts will be next billed and based on the duration of the plan.
        ...
        <div class="para40">
            <p>The End User agrees to the terms and conditions set forth in this agreement for a term of one month.
                At the end of this term the agreement shall automatically renew monthly until either party provides 30 days prior notice to the other party to terminate. </p>
        </div>
        ...
        <div class="para40">
            ...
            <p>
                All data plan purchases are non refundable and unused standard plan Image Points expire at the end of the plan period.
            </p>

            <p>The standard data plans are billed for in advance. At the time of point of sale, End User selects the service plan
                which is represented clearly with duration and full cost.</p>

            <p>
                Some service plans may be initially offered with a FREE first month. Any renewals of these same plans will be at
            ...
            <p>All data plan purchases are billed for in entirety for their initital and stated duration.  Should End User elect to use the Auto-Bill option, then on the next
                renewal there will be a proration or discount applied based on the users existing Billing Cycle.  If this is End User's initital plan purchase
            ...
            <p>
                In order to re-activate a data plan that is beyond its Service End Date, the End User should click the Renew Plan button.  The point of sale
                transaction and price will constitute the full amount for the plan chosen and End User may elect to change the plan terms (Tier) to a different duration,
                of which the disclosed price will be added to cart and charged in full.  Thus, once a Data Plan expires, and is suspended and beyond its Service End Date,
                the plan may be renewed with different terms.
            </p>
        ...
        <div class="para40">
            <p>Wireless Service uses radio technologies and is subject to transmission and service area limitations and interruptions
                caused by atmospheric, topographical or environmental conditions, tower availability, Equipment or its installation,
                governmental regulations, system limitations, maintenance or other conditions or activities affecting Wireless Service
                operation. Wireless Service and/or features may not be available in all areas. Wireless Service is only available
                within each applicable plan coverage area, within the operating range of the wireless systems, and with Equipment
                that is approved to operate on the respective Carrier's network.
            </p>
        </div>
        ...
        <h4>12. Media file Retention on the Portal</h4>
        <div class="para40">
            <p>
                <strong>Media Retention is 90 days for each camera.  When media files become older than 90 days, they are purged on a daily basis. </strong>Make sure you have offline copies
                of any media files that you can't lose.  Keep in mind originals are on your camera's SD card but the portal also allows you to format the SD card.
            </p>
        </div>
