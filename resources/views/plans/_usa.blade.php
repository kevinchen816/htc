                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="alert alert-default alert-ratetier">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="radio">
                                                    <label><input type="radio" name="tier"  value="20" ><span style="color:white;">12.95</span> <span style="color:lime;">per Month</span> <span style="color:red;">[cpp: 0.00259]</span></label>
                                                </div>
                                                <div class="radio">
