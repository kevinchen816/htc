...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script>
        ...
        var lastLat = 24.173507; //24.171243848401744;
        var lastLng = 120.65616; //120.6455130413344;
        var myCenter = new BMap.Point(lastLng, lastLat);
        ...
        function initialize() {
            ...
            $.post(WEB_POSITION_URL, urlParam, function (data) {
                ...
                // if (data.result == 0 && data.position) {
                if (data.result == 0) {
