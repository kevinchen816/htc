                ...
                <div class="panel panel-default panel-primary custom-settings-panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group " id="field-wrapper-54-photoresolution">
                            ...
                            <div class="col-md-7">
                                <select id="54_photoresolution" class="bs-select form-control input-sm"   name="54_photoresolution">
                                    <option value="4" selected="selected">4MP 16:9</option>
                                    <option value="6">6MP 16:9</option>
                                    <option value="8">8MP 16:9</option>
                                    <option value="12">12MP 16:9</option>
                                </select>
                        ...
                        <div class="form-group  hidden" id="field-wrapper-54-video_resolution">
                            ...
                            <div class="col-md-7">
                                <select id="54_video_resolution" class="bs-select form-control input-sm"   name="54_video_resolution">
                                    <option value="8" selected="selected">Standard Low</option>
                                    <option value="9">Standard Medium</option>
                                    <option value="10">Standard High</option>
                                    <option value="11">High Def</option>
                                </select>
                        ...
                        <div class="form-group  hidden" id="field-wrapper-54-video_rate">
                            ...
                            <div class="col-md-7">
                                <select id="54_video_rate" class="bs-select form-control input-sm"   name="54_video_rate">
                                    <option value="4" selected="selected">4fps</option>
                        ...
                        <div class="form-group  hidden" id="field-wrapper-54-video_bitrate">
                            ...
                            <div class="col-md-7">
                                <select id="54_video_bitrate" class="bs-select form-control input-sm"   name="54_video_bitrate">
                                    <option value="300">1 (default/smallest)</option>
                                    ...
                                    <option value="900">7</option>
                                    <option value="1000">8 (balanced)</option>
                                    <option value="1200">9</option>
                                    <option value="1400">10</option>
                                    <option value="1800">11</option>
                                    <option value="2500">12 (High)</option>
                                    <option value="5000">13 (Maximum/LARGE!)</option>
                                </select>
                        ...
                        <div class="form-group  hidden" id="field-wrapper-54-video_length">
                            ...
                            <div class="col-md-7">
                                <select id="54_video_length" class="bs-select form-control input-sm"   name="54_video_length">
                                    <option value="2s">2s</option>
                                    <option value="3s">3s</option>
                                    <option value="4s">4s</option>
                                    <option value="5s" selected="selected">5s</option>
